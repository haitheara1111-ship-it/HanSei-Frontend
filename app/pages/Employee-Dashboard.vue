    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="bg-white rounded-lg shadow p-5 flex items-center gap-4">
        <div class="bg-orange-500 p-3 rounded-full">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-white" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div>
          <p class="text-gray-500 text-sm">Attendance Overview</p>
          <p class="text-xl font-bold">120/154</p>
          <p class="text-blue-500 text-sm mt-1 cursor-pointer">View Details</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-5 flex items-center gap-4">
        ...
        <div>
          <p class="text-gray-500 text-sm">Total No of Projects</p>
          <p class="text-xl font-bold">90/125</p>
          <p class="text-blue-500 text-sm mt-1 cursor-pointer">View All</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-5 flex items-center gap-4">
        <div class="bg-blue-500 p-3 rounded-full">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-white" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <path d="M17 11c2 0 4 2 4 4v3H3v-3c0-2 2-4 4-4"/>
          </svg>
        </div>

        <div>
          <p class="text-gray-500 text-sm">Total No of Clients</p>
          <p class="text-xl font-bold">69/86</p>
          <p class="text-blue-500 text-sm mt-1 cursor-pointer">View All</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-5 flex items-center gap-4">
        ...
        <div>
          <p class="text-gray-500 text-sm">Total No of Tasks</p>
          <p class="text-xl font-bold">96/100</p>
          <p class="text-blue-500 text-sm mt-1 cursor-pointer">View All</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-5 flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-xl font-bold">$21,445</p>
          <p class="text-blue-500 text-sm mt-1 cursor-pointer">View All</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-5 flex items-center gap-4">
        ...
        <div>
          <p class="text-gray-500 text-sm">Profit This Week</p>
          <p class="text-xl font-bold">$5,544</p>
          <p class="text-blue-500 text-sm mt-1 cursor-pointer">View All</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-5 flex items-center gap-4">
        ...
        <div>
          <p class="text-gray-500 text-sm">Job Applicants</p>
      ...
      <div class="bg-white rounded-lg shadow p-5 flex items-center gap-4">
        ...
        <div>
          <p class="text-gray-500 text-sm">New Hire</p>
          <p class="text-xl font-bold">45/48</p>
          <p class="text-blue-500 text-sm mt-1 cursor-pointer">View All</p>
        </div>
      </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="bg-white rounded-lg shadow">
        <div class="flex justify-between items-center p-4 border-b">
          ...
          <button class="text-sm bg-gray-100 px-3 py-1 rounded">View All</button>
        </div>
        ...
        <div class="p-4 space-y-4">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="font-medium">Alexander Jermai</p>
            ...
            <div class="flex gap-2">
              <button class="p-2 bg-gray-100 rounded">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                  <path d="M22 16.92V19a2 2 0 01-2.18 2 19.8 19.8 0 01-8.63-3.07 19.5 19.5 0 01-6-6A19.8 19.8 0 012 4.18 2 2 0 014 2h2.09a2 2 0 012 1.72c.12.9.37 1.78.72 2.6a2 2 0 01-.45 2.11L7.09 9.91a16 16 0 006 6l1.48-1.27a2 2 0 012.11-.45c.82.35 1.7.6 2.6.72A2 2 0 0122 16.92z"/>
                </svg>
              </button>
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="font-medium">Daniel Esbella</p>
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="font-medium">Andrew Jermia</p>
      ...
      <div class="bg-white rounded-lg shadow">
        ...
        <div class="p-4 space-y-4">
          <div class="flex gap-3">
            ...
            <div>
              <p class="font-medium text-sm">Lex Murphy requested access to UNIX</p>
              <p class="text-xs text-gray-500">Today at 9:42 AM</p>
            </div>
          </div>
          ...
          <div class="flex gap-3">
            ...
            <div>
              <p class="font-medium text-sm">Lex Murphy requested access to UNIX</p>
              <p class="text-xs text-gray-500">Today at 10:00 AM</p>
            </div>
          </div>

          <div class="flex gap-3">
            <img src="https://i.pravatar.cc/40?img=13" class="w-10 h-10 rounded-full"/>
            <div>
              <p class="font-medium text-sm">Lex Murphy requested access to UNIX</p>
              <p class="text-xs text-gray-500">Today at 12:00 PM</p>

              <div class="flex gap-2 mt-2">
                <button class="bg-orange-500 text-white px-3 py-1 text-xs rounded">
                  Approve
                </button>
                <button class="border px-3 py-1 text-xs rounded">
                  Decline
                </button>
              </div>
            </div>
      ...
      <div class="bg-white rounded-lg shadow">
        <div class="flex justify-between items-center p-4 border-b">
          <h2 class="font-semibold text-gray-700">Meetings Schedule</h2>
          <button class="text-sm bg-gray-100 px-3 py-1 rounded">Today</button>
        </div>

        <div class="p-4 space-y-4">

          <div class="flex gap-3">
            <span class="text-sm text-gray-500 w-20">09:25 AM</span>
            <div class="bg-gray-50 p-3 rounded w-full">
              <p class="font-medium text-sm">Marketing Strategy Presentation</p>
              <p class="text-xs text-gray-500">Marketing</p>
            </div>
          </div>

          <div class="flex gap-3">
            <span class="text-sm text-gray-500 w-20">09:20 AM</span>
            <div class="bg-gray-50 p-3 rounded w-full">
          ...
          <div class="flex gap-3">
            <span class="text-sm text-gray-500 w-20">09:18 AM</span>
            <div class="bg-gray-50 p-3 rounded w-full">
              <p class="font-medium text-sm">Birthday Celebration of Employee</p>
              <p class="text-xs text-gray-500">Celebration</p>
            </div>
          </div>
...
<div class="bg-white rounded-lg shadow mb-6">
    ...
    <!-- Header -->
    <div class="flex justify-between items-center p-4 border-b">
      <h2 class="font-semibold text-gray-700">My Skills</h2>

      <button class="flex items-center gap-2 text-sm bg-gray-100 px-3 py-1 rounded">
    ...
    <div class="p-4 space-y-4">
      ...
      <!-- Skill -->
      <div class="flex justify-between items-center bg-gray-50 p-4 rounded border border-dashed">
        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500">Updated : 15 May 2025</p>
          </div>
        </div>

        <!-- Progress Circle -->
        <div class="relative w-14 h-14">
          <svg class="w-14 h-14 rotate-[-90deg]" viewBox="0 0 36 36">
      ...
      <div class="flex justify-between items-center bg-gray-50 p-4 rounded border border-dashed">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500">Updated : 12 May 2025</p>
          </div>
        </div>
        ...
        <div class="relative w-14 h-14">
          <svg class="w-14 h-14 rotate-[-90deg]" viewBox="0 0 36 36">
            <circle cx="18" cy="18" r="15" stroke="#e5e7eb" stroke-width="3" fill="none"/>
            <circle cx="18" cy="18" r="15" stroke="#22c55e" stroke-width="3" fill="none" stroke-dasharray="85,100"/>
          </svg>
          <span class="absolute inset-0 flex items-center justify-center text-xs font-semibold">85%</span>
        </div>
      </div>
      ...
      <div class="flex justify-between items-center bg-gray-50 p-4 rounded border border-dashed">
        ...
        <div class="relative w-14 h-14">
          <svg class="w-14 h-14 rotate-[-90deg]" viewBox="0 0 36 36">
            <circle cx="18" cy="18" r="15" stroke="#e5e7eb" stroke-width="3" fill="none"/>
            <circle cx="18" cy="18" r="15" stroke="#a855f7" stroke-width="3" fill="none" stroke-dasharray="70,100"/>
          </svg>
          <span class="absolute inset-0 flex items-center justify-center text-xs font-semibold">70%</span>
        </div>
      </div>
      ...
      <div class="flex justify-between items-center bg-gray-50 p-4 rounded border border-dashed">
        ...
        <div class="relative w-14 h-14">
          <svg class="w-14 h-14 rotate-[-90deg]" viewBox="0 0 36 36">
            <circle cx="18" cy="18" r="15" stroke="#e5e7eb" stroke-width="3" fill="none"/>
            <circle cx="18" cy="18" r="15" stroke="#3b82f6" stroke-width="3" fill="none" stroke-dasharray="61,100"/>
          </svg>
          <span class="absolute inset-0 flex items-center justify-center text-xs font-semibold">61%</span>
        </div>
      </div>
      ...
      <div class="flex justify-between items-center bg-gray-50 p-4 rounded border border-dashed">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500">Updated : 13 May 2025</p>
          </div>
        </div>
        ...
        <div class="relative w-14 h-14">
          <svg class="w-14 h-14 rotate-[-90deg]" viewBox="0 0 36 36">
            <circle cx="18" cy="18" r="15" stroke="#e5e7eb" stroke-width="3" fill="none"/>
            <circle cx="18" cy="18" r="15" stroke="#374151" stroke-width="3" fill="none" stroke-dasharray="58,100"/>
          </svg>
          <span class="absolute inset-0 flex items-center justify-center text-xs font-semibold">58%</span>
        </div>
      </div>
